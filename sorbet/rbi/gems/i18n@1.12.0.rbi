...
class I18n::Railtie < ::Rails::Railtie
  class << self
    # source://activesupport/6.1.7/lib/active_support/i18n_railtie.rb#78
    def forward_raise_on_missing_translations_config(app); end

    # source://activesupport/6.1.7/lib/active_support/i18n_railtie.rb#88
    def include_fallbacks_module; end

    # source://activesupport/6.1.7/lib/active_support/i18n_railtie.rb#92
    def init_fallbacks(fallbacks); end

    # source://activesupport/6.1.7/lib/active_support/i18n_railtie.rb#32
    def initialize_i18n(app); end

    # source://activesupport/6.1.7/lib/active_support/i18n_railtie.rb#108
    def validate_fallbacks(fallbacks); end

    # source://activesupport/6.1.7/lib/active_support/i18n_railtie.rb#119
